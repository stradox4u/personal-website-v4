...
<template>
  <nav class="w-full py-4 sticky top-0 z-10 bg-myLightGray">
    <div class="flex sm:justify-end justify-stretch max-w-7xl mx-auto">
      <ul class="sm:flex justify-between gap-x-8 hidden">
        <li>
